...
class AuthApiDocsTest {
    ...
    void apiDocs_loadsWithoutSpringdocError() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/auth/password-reset/request']").exists())
                .andExpect(jsonPath("$.paths['/api/v1/auth/password-reset/verify-otp']").exists())
                .andExpect(jsonPath("$.paths['/api/v1/auth/password-reset/reset-password']").exists())
